...
function ServiceCard({ service, index }: { service: any, index: number }) {
  ...
  return (
    <motion.div
      ...
      className={`glass-card p-8 rounded-3xl relative overflow-hidden group cursor-default transition-transform duration-200 ease-out`}
    ...
    >
      ...
      <div className="relative z-10 pointer-events-none" style={{ transform: 'translateZ(30px)' }}>
        ...
        <h3 className="text-2xl font-bold text-white mb-3 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-white group-hover:to-gray-400 transition-all duration-300">{service.title}</h3>
